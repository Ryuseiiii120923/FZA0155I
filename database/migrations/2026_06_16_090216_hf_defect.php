...
return new class extends Migration
{
    ...
    {
        Schema::connection('PRecord')->create('hf_defect', function (Blueprint $table) {
            $table->id();
        ...
        Schema::connection('PRecord')->create('hf_forms', function (Blueprint $table) {
            $table->id();
            $table->integer('ppfno')->index();
        ...
        Schema::connection('PRecord')->create('hf_small', function (Blueprint $table) {
            $table->id();
            $table->integer('ppfno')->index();
            $table->string('hfid', 10)->index();
        ...
        Schema::connection('PRecord')->create('hf_rework', function (Blueprint $table) {
            $table->id();
            $table->integer('ppfno')->index();
            $table->string('hfid', 10)->index();
    ...
    {
        Schema::connection('PRecord')->dropIfExists('hf_rework');
        Schema::connection('PRecord')->dropIfExists('hf_small');
        Schema::connection('PRecord')->dropIfExists('hf_forms');
        Schema::connection('PRecord')->dropIfExists('hf_defect');
    }
};
